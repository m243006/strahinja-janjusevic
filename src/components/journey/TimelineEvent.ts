...
export const timeline: TimelineEvent[] = [
  {
    ...
    delay: 0.1,
    position: { x: 20, y: 10 },  // Moved up slightly
  ...
  },
  {
    ...
    delay: 0.2,
    position: { x: 35, y: 30 },  // Adjusted position
  ...
  },
  {
    ...
    delay: 0.3,
    position: { x: 25, y: 50 },  // Moved left and up
  ...
  },
  {
    ...
    delay: 0.4,
    position: { x: 40, y: 70 },  // Moved up slightly
  ...
  },
  {
    ...
    delay: 0.5,
    position: { x: 20, y: 90 },  // Moved left and up
